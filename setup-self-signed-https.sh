...
sudo mkdir -p /etc/ssl/geo7

# Gerar certificado auto-assinado
echo "3. Gerando certificado SSL auto-assinado..."
sudo openssl req -x509 -nodes -days 365 -newkey rsa:2048 \
    -keyout /etc/ssl/geo7/privkey.pem \
    -out /etc/ssl/geo7/fullchain.pem \
    -subj "/C=BR/ST=SP/L=SaoPaulo/O=Geo7/OU=IT/CN=18-228-94-6.sslip.io"
...
echo ""
echo "⚠️ NOTA: Certificado auto-assinado - navegador mostrará aviso de segurança"
echo "   Clique em 'Avançado' e 'Prosseguir para o site' para acessar"
echo ""
